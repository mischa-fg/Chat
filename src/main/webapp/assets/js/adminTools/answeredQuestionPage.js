...
function loadStuffAnsweredQuestions(timeRange, elementOfLoaderID, buttonElement, initialization = false) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            let response = yield fetch(`${server}/services/get/allAnsweredQuestions?timeRange=${timeRange}&withAnswers=false`);
...
function saveAnsweredQuestions(questions) {
    if (questions != null) {
        answeredQuestions = [];
