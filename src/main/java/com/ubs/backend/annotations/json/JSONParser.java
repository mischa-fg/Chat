...
import com.ubs.backend.annotations.json.handlers.DefaultHandlers;
...
public class JSONParser {
    ...
    public JSONParser() {
        ...
        DefaultHandlers.BooleanHandler bool = new DefaultHandlers.BooleanHandler();
        DefaultHandlers.DoubleHandler dbl = new DefaultHandlers.DoubleHandler();
        DefaultHandlers.FloatHandler flt = new DefaultHandlers.FloatHandler();
        DefaultHandlers.ListHandler list = new DefaultHandlers.ListHandler();
        DefaultHandlers.EnumerationHandler enm = new DefaultHandlers.EnumerationHandler();
        DefaultHandlers.IntegerHandler integer = new DefaultHandlers.IntegerHandler();
        DefaultHandlers.JSONAnnotatedHandler json = new DefaultHandlers.JSONAnnotatedHandler();
        DefaultHandlers.StringHandler str = new DefaultHandlers.StringHandler();

        handlers.put(bool.getType(), bool);
        handlers.put(dbl.getType(), dbl);
        handlers.put(flt.getType(), flt);
        handlers.put(list.getType(), list);
        handlers.put(enm.getType(), enm);
        handlers.put(integer.getType(), integer);
        handlers.put(json.getType(), json);
        handlers.put(str.getType(), str);
    }
    ...
    private String getJsonString(Object object) throws JsonSerializationException, IllegalAccessException, ElementTypeException, InvocationTargetException {
        // Get class of object
        Class<?> clazz = object.getClass();
    ...
    private void handleKeyObjectPair(Map<String, String> jsonElements, String key, Object o, String type) throws ElementTypeException, JsonSerializationException {
        if (o == null) {
    ...
    public String listToJSON(Object[] values, Class<?> clazz, ParserResponseType response) throws JsonSerializationException {
        return listToJSON(Arrays.asList(values), clazz, response);
    }
    ...
    public static class JsonSerializationException extends Throwable {
        ...
        public static String getHandlerRecommendations(Object o, Map<String, ElementHandler> handlers) {
            ...
            if (handler != null) {
                return "Try changing the customType to \"" + handler.getType() + "\"";
            }
