 ...
 * @since 10.08.2021
 */
public class AmountAnswersMonth implements Statistic {
    @Override
    public Answer getFact(EntityManager em) {
        ...
        if (statistikTimes != null) {
            amountAnswers = answerStatistikDAO.countAskedAmountSingleMonth(statistikTimes, em);
        }
        ...
        if (amountAnswers > 0) {
            if (amountAnswers > 1) {
                inhalt = "In diesem Monat wurden " + amountAnswers + " Fragen beantwortet!";
            } else {
                inhalt = "In diesem Monat wurde " + amountAnswers + " Frage beantwortet!";
            }
        } else {
            inhalt = "In diesem Monat wurden noch keine Fragen beantwortet!";
        }
