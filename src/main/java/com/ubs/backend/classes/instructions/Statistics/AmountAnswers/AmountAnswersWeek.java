 ...
 * @since 10.08.2021
 */
public class AmountAnswersWeek implements Statistic {
    @Override
    public Answer getFact(EntityManager em) {
        ...
        if (statistikTimes != null) {
            amountAnswers = answerStatistikDAO.countAskedAmountSingleWeek(statistikTimes, em);
        }
        ...
        if (amountAnswers > 0) {
            if (amountAnswers > 1) {
                inhalt = "In dieser Woche wurden " + amountAnswers + " Fragen beantwortet!";
            } else {
                inhalt = "In dieser Woche wurde " + amountAnswers + " Frage beantwortet!";
            }
        } else {
            inhalt = "In dieser Woche wurden noch keine Fragen beantwortet!";
        }
