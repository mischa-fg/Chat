 ...
 * @since 10.08.2021
 */
public class AmountAnswersDay implements Statistic {
    @Override
    public Answer getFact(EntityManager em) {
        ...
        if (statistikTimes != null) {
            amountAnswers = answerStatistikDAO.countAskedAmountSingleDay(statistikTimes, em);
        }
        ...
        if (amountAnswers > 0) {
            if (amountAnswers > 1) {
                inhalt = "Heute wurden " + amountAnswers + " Fragen beantwortet!";
            } else {
                inhalt = "Heute wurde " + amountAnswers + " Frage beantwortet!";
            }
        } else {
            inhalt = "Heute wurden noch keine Fragen beantwortet!";
        }
